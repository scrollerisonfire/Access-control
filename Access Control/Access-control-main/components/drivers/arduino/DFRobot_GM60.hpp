...
#define REG_IDENTIFY_EAN13_2     0X002F
#define REG_IDENTIFY_EAN13_5     0X0030
#define REG_IDENTIFY_EAN8        0X0031
#define REG_IDENTIFY_EAN8_2      0X0032
#define REG_IDENTIFY_EAN8_5      0X0033
#define REG_IDENTIFY_UPCA        0X0034
#define REG_IDENTIFY_UPCA_2        0X0035
#define REG_IDENTIFY_UPCA_5        0X0036
#define REG_IDENTIFY_UPCE0        0X0037
#define REG_IDENTIFY_UPCE1        0X0038
#define REG_IDENTIFY_UPCE1_2        0X0039
#define REG_IDENTIFY_UPCE1_5        0X003A
...
// LED controll
#define REG_LIGHTS 0x0014
#define REG_LEDS_0_1 0x001B
#define REG_LEDS_2_3 0x001C
#define REG_LEDS_4_5 0x001D
#define REG_LEDS_6_7 0x001E
#define REG_LEDS_CYCLE 0x001F
#define REG_SUCCESS 0x0000
...
public:
  ...
  bool stopReading();
  bool setOnlyRedLED();
  bool setOnlyGreenLED();
  bool cycleLEDs(uint8_t data);
  bool setLight(uint8_t light);
  bool successReadLEDs();
  bool rawCommand(uint16_t reg,uint8_t data);
